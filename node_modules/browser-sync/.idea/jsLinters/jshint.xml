...
<project version="4">
  <component name="JSHintConfiguration" version="2.4.4" use-config-file="true" use-custom-config-file="true" custom-config-file-path="$PROJECT_DIR$/../browser-sync-modules/browser-sync-client/test/.jshintrc">
    <option asi="false" />
    <option bitwise="true" />
    <option boss="false" />
